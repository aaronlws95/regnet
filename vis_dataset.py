...
for _ in range(5):
    ...
    gt_depth_img = dataset.get_depth_image(index, dataset.velo_extrinsic, img.shape, dataset.h_fov, dataset.v_fov)
    ...
    init_projected_img = cv2.resize(init_projected_img, (dataset.img_size, dataset.img_size))
    ...
    gt_projected_img = cv2.resize(gt_projected_img, (dataset.img_size, dataset.img_size))
